...
$routes->get('producto-detalle', 'Front::productoDetalle');
$routes->get('proyectos', 'Front::proyectos');
$routes->get('blog', 'Front::blog');
$routes->get('blog-detalle', 'Front::blogDetalle');
...
$routes->get('politicas-de-cambios-y-devoluciones', 'Front::politicasCambiosDevoluciones');
