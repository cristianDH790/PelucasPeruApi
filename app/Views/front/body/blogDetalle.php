	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-9">
				...
				<h6><?= $blogdetalle->categoria_nombre ?></h6>
				<h2><?= $blogdetalle->nombre ?></h2>
				<div class="bloque-compartir">
					<h5><i class="fa-solid fa-calendar-days"></i> <?= $blogdetalle->fechapublicacion ?></h5>
					<span>|</span>
				...
				<div class="box-noticias">
					<div class="row">
						...
						<? foreach ($noticias as $noticia): ?>
							<? if ($noticia->idnoticia != $blogdetalle->idnoticia): ?>
								<div class="col-md-12">
									<div class="noti-img">
										<img src="<?= base_url(); ?>archivos/noticia/<?= $noticia->urlimagen ?>" alt="">
									</div>
									<div class="box-noti">
										<?
										$dia = date('d', strtotime($noticia->fechapublicacion)); // "18"
										$mes = date('M', strtotime($noticia->fechapublicacion)); // "Sep"
										?>
										<span class="fecha">
											<span class="fecha">
												<h1><?= $dia ?></h1>
										...
										<a href="<?= base_url(); ?>blog-detalle/<?= $noticia->urlamigable ?>">Ver más</a>
									</div>
								</div>
							<? endif; ?>
