...
<section class="productos-int">
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12">
				<h2>Categoria lentes de contacto</h2>
				...
				<div class="productos-todos" id="lentes">
					<div class="row">
						...
						<? foreach ($productocategorias as $productocategoria): ?>
							<div class="col-md-3">
								<div class="bg-image">
									<a href="<?= base_url(); ?>productos/lentes/<?= $productocategoria->urlamigable ?>">
										<img src="<?= base_url(); ?>archivos/productocategoria/<?= $productocategoria->urlimagen ?>" class="img1" alt="">
									</a>
								</div>
								<div class="bg-resumen">
									<h3><?= $productocategoria->nombre ?></h3>
									<div class="btns">
										<a href="<?= base_url(); ?>productos/lentes/<?= $productocategoria->urlamigable ?>" class="comprar">ver mas</a>
									</div>
								</div>
							</div>
						<? endforeach; ?>
